...
?>
    <div class="container">
        ...
        <p>
        <h1 align="center">Data Table using Mysqli Database and Bootstrap with Modal Form</h1>
        </p>
            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <a href="#deleteEmployeeModalselected" class="btn btn-danger" data-toggle="modal"><i
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="?editemployee=<?php echo $row['id']; ?>" class="edit" data-toggle="modal"><i
                                    class="material-icons" data-toggle="tooltip" title="Edit"></i></a>
                            <a href="?deleteemployee=<?php echo $row['id']; ?>" class="delete" data-toggle="modal"><i
            ...
            <div class="modal-content">
                <form name="frmedit" action="" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="editname" value="<?php echo $edit_fullname; ?>"
                                class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="editemail" value="<?php echo $edit_emailadd; ?>"
                                class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <textarea class="form-control" name="editaddress"
                                required><?php echo $edit_address; ?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Phone</label>
                            <input type="text" name="editphone" value="<?php echo $edit_phone; ?>" class="form-control"
                                required>
                        </div>
                    </div>
                    <div class="modal-footer">
